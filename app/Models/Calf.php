...
class Calf extends Model
{
    ...
    protected $fillable = [
        'id','DOB', 'animal_id', 'age', 'weight', 'height',	'gender', 'color', 'animal_type','animal_breed', 'pictures', 'buy_from', 'buying_price', 'shade_no', 'previous_vaccine_done', 'buy_date', 'branch_id', 'vaccines', 'sale_status', 'note','user_id','father_id','father_name','company_name','claf_blood'
    ];
