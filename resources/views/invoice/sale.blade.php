          ...
          <div class="card-body">
            <div class="row mb-4">
              <div class="col-sm-8">
                ...
                <div>{{__('invoice.email') }}:@if(!empty($branchFullData->email)){{$branchFullData->email}}@endif </div>
                <div>{{__('invoice.phone') }}:@if(!empty($branchFullData->phone_number)){{$branchFullData->phone_number}}@endif</div>
              </div>
              <div class="col-sm-4">
