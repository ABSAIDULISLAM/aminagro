...
<form action="{{ route('buyer.update', $buyer->id) }}" method="POST">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="inputEmail4" placeholder="Name" name="name" value="{{ $buyer->name }}">
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Phone*</label>
      <input type="text" class="form-control" id="inputPassword4" placeholder="Phone" name="phone" value="{{ $buyer->phone }}">
    </div>
  </div>
    <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4">Address*</label>
      <input type="text" class="form-control" id="inputEmail4" placeholder="Address" name="address" value="{{ $buyer->address }}">
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Balance*</label>
      <input type="text" class="form-control" id="inputPassword4" placeholder="Balance" name="balance" value="{{ $buyer->balance }}">
    </div>
  </div>
