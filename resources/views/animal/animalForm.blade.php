...
<section class="content">
    ...
    <div class="box box-success">
        ...
        <div class="box-header with-border" align="right">
            ...
            <a href="{{  url('animal/create')  }}" class="btn btn-warning btn-sm"><i class="fa fa-refresh"></i> <b> {{__('same.refresh') }}</b></a> &nbsp;&nbsp;
        </div>
        <div class="box-body">
            <div class="col-md-12">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="animal-id">{{__('Animal ID') }} : </label>
                                        <input id="animal-id" type="text" name="id" placeholder="Animal ID" class="form-control" value="{{ !empty($single_data->id) ? $single_data->id : '' }}" {{ !empty($single_data->id) ? 'readonly' : '' }}>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-addon animal-month">{{(!empty($single_data->age))?number_format((float)$single_data->age / 30,2,".","."):'0 '}} Month</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="gender" id="genderSelect" onchange="showGenderSpecificFields()">
                                ...
                                <!--<div class="col-md-4">-->
                                <!--  <div class="form-group">-->
                                <!--    <label for="gender">{{__('Gender Type') }} : </label>-->
                                <!--    <select class="form-control" name="genderbn" id="genderSelect" onchange="showGenderSpecificFields()">-->
                                <!--      <option value="ষাড়">ষাড়</option>-->
                                <!--      <option value="গাভী">গাভী</option>-->
                                <!--    </select>-->
                                <!--  </div>-->
                                <!--</div>-->

                                <!-- Fields that appear when ষাড় (option 1) is selected -->
                                <div id="shadFields" style="display:none;">
                                    <!--<div class="col-md-4">-->
                                    <!--  <div class="form-group">-->
                                    <!--    <label for="Teeth">{{__('Teeth') }} : </label>-->
                                    <!--    <input type="text" class="form-control" name="Teeth" placeholder="Teeth">-->
                                    <!--  </div>-->
                                    <!--</div>-->
                                    <!--<div class="col-md-4">-->
                                    <!--  <div class="form-group">-->
                                    ...
                                    <!--      <option value="Fettaining">Fettaining</option>-->
                                    <!--    </select>-->
                                    <!--  </div>-->
                                    <!--</div>-->
                                    <!--<div class="col-md-4">-->
                                    <!--  <div class="form-group">-->
                                    <!--    <label for="Bull_Stage">{{__('Bull Stage') }} : </label>-->
                                    <!--    <select class="form-control" name="Bull_Stage">-->
                                    <!--      <option value="Calf">Calf</option>-->
                                    <!--      <option value="Weaner">Weaner</option>-->
                                    <!--      <option value="Steer">Steer</option>-->
                                    <!--      <option value="Bull Blood %">Bull Blood %</option>-->
                                    <!--    </select>-->
                                    <!--  </div>-->
                                    <!--</div>-->
                                </div>

                                <!-- Fields that appear when গাভী (option 2) is selected -->
                                <div id="gaviFields" style="display:none;">
                                    <!--<div class="col-md-4">-->
                                    <!--  <div class="form-group">-->
                                    <!--    <label for="Teeth">{{__('Teeth') }} : </label>-->
                                    <!--    <input type="text" class="form-control" name="Teeth" placeholder="Teeth">-->
                                    ...
                                    <!--  <div class="col-md-4">-->
                                    <!--  <div class="form-group">-->
                                    <!--    <label for="Cow_Stage">{{__('Cow Stage') }} : </label>-->
                                    <!--    <select class="form-control" name="Cow_Stage">-->
                                    <!--      <option value="Calf">Calf</option>-->
                                    <!--      <option value="Weaner">Weaner</option>-->
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="Pragnant_Status">{{ __('Pragnant Status') }} :</label>
                                            <select class="form-control" name="Pragnant_Status" id="Pragnant_Status">
                                                <option value="Yes" {{ (!empty($single_data->Pragnant_Status) && $single_data->Pragnant_Status == 'Yes') ? 'selected' : '' }}>Yes</option>
                                                <option value="No" {{ (!empty($single_data->Pragnant_Status) && $single_data->Pragnant_Status == 'No') ? 'selected' : '' }}>No</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="Caving_Date">{{__('Caving Date') }} : </label>
                                            <input type="date" class="form-control" name="Caving_Date" placeholder="Caving Date" value="{{(!empty($single_data->Caving_Date))?$single_data->Caving_Date:''}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="Lactating">{{__('Lactating') }} : </label>
                                            <input type="text" class="form-control" name="Lactating" placeholder="Lactating"value="{{(!empty($single_data->Lactating))?$single_data->Lactating:''}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="Non_Lactating">{{__('Non Lactating') }} : </label>
                                            <input type="text" class="form-control" name="Non_Lactating" placeholder="Non Lactating"{{(!empty($single_data->Non_Lactating))?$single_data->Non_Lactating:''}}>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="Company_Name">{{__('Company Name') }} : </label>
                                            <input type="text" class="form-control" name="Company_Name" placeholder="Company Name" value="{{(!empty($single_data->Company_Name))?$single_data->Company_Name:''}}">
                                        </div>
                                    </div>
                                ...
                                <script>
                                    function showGenderSpecificFields() {
                                        var genderSelect = document.getElementById('genderSelect');
                                        var shadFields = document.getElementById('shadFields');
                                        var gaviFields = document.getElementById('gaviFields');

                                        // Hide both fields initially
                                        shadFields.style.display = 'none';
                                        gaviFields.style.display = 'none';

                                        // Show the appropriate fields based on selection
                                        if (genderSelect.value == "{{__('manage_cow.male')}}") {
                                            shadFields.style.display = 'block';
                                        } else if (genderSelect.value == "{{__('manage_cow.female')}}") {
                                            gaviFields.style.display = 'block';
                                        }
                                    }
                                </script>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="Teeth">{{__('Teeth') }} : </label>
                                        <input type="text" class="form-control" name="Teeth" placeholder="Teeth" value="{{(!empty($single_data->Teeth))?$single_data->Teeth:''}}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                <div class="form-group">
                                        <label for="Purpose">{{ __('Purpose') }} : </label>
                                        <select class="form-control" name="Purpose">
                                            <option value="Breeding" {{ old('Purpose', $single_data->Purpose ?? '') == 'Breeding' ? 'selected' : '' }}>Breeding</option>
                                            <option value="Fettaining" {{ old('Purpose', $single_data->Purpose ?? '') == 'Fettaining' ? 'selected' : '' }}>Fettaining</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="Bull_Stage">{{ __('Stage') }} <span class="validate">*</span> : </label>
                                        <select class="form-control" name="Bull_Stage">
                                            <option value="Calf" {{ old('Bull_Stage', $single_data->Bull_Stage ?? '') == 'Calf' ? 'selected' : '' }}>Calf</option>
                                            <option value="Weaner" {{ old('Bull_Stage', $single_data->Bull_Stage ?? '') == 'Weaner' ? 'selected' : '' }}>Weaner</option>
                                            <option value="Steer" {{ old('Bull_Stage', $single_data->Bull_Stage ?? '') == 'Steer' ? 'selected' : '' }}>Steer</option>
                                            <option value="Bull" {{ old('Bull_Stage', $single_data->Bull_Stage ?? '') == 'Bull' ? 'selected' : '' }}>Bull</option>
                                            <option value="Blood %" {{ old('Bull_Stage', $single_data->Bull_Stage ?? '') == 'Blood %' ? 'selected' : '' }}>Blood %</option>
                                            <option value="Heifer" {{ old('Bull_Stage', $single_data->Bull_Stage ?? '') == 'Heifer' ? 'selected' : '' }}>Heifer</option>
                                            <option value="Cow" {{ old('Bull_Stage', $single_data->Bull_Stage ?? '') == 'Cow' ? 'selected' : '' }}>Cow</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="animal_breed">{{__('Animal Breed') }} : </label>
                                        <select class="form-control" name="animal_breed">
                                            <option value="">{{__('same.select') }}</option>
                                            @foreach($all_animal_breed as $animal_types)
                                            <option value="{{$animal_types->id}}" {{(!empty($single_data))?($animal_types->id==$single_data->animal_breed)?'selected':'':''}}>{{$animal_types->type_name}}</option>
                                            @endforeach
