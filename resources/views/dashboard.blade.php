   ...
   <!-- </div>-->
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box"> <span class="info-box-icon bg-green"><img src="public/custom/img/milk-sold-amount.png"></span>
        <div class="info-box-content"> <span class="info-box-text">{{__('Todys Expenses') }}</span> <span class="info-box-number">{{\App\Library\farm::currency($TodysExpenses)}}</span> </div>
      </div>
    </div>
    <div class="col-md-3 col-sm-6 col-xs-12">
	  <div class="info-box"> <span class="info-box-icon bg-red"><img src="public/custom/img/cow-stalls.png"></span>
        <div class="info-box-content"> <span class="info-box-text">{{__('Permanent Expense') }}</span> <span class="info-box-number">{{\App\Library\farm::currency($PermanentExpense)}}</span> </div>
      </div>
    </div>
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box"> <span class="info-box-icon bg-yellow"><img src="public/custom/img/milk-collect-amount.png"></span>
        <div class="info-box-content"> <span class="info-box-text">{{__('Total Earning') }}</span> <span class="info-box-number">{{\App\Library\farm::currency($totalEarnings)}}</span> </div>
      </div>
    </div>
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box"> <span class="info-box-icon bg-yellow"><img src="public/custom/img/milk-collect-amount.png"></span>
        <div class="info-box-content"> <span class="info-box-text">{{__('Todays Earning') }}</span> <span class="info-box-number">{{\App\Library\farm::currency($TodysEarnings)}}</span> </div>
      </div>
    </div>
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box"> <span class="info-box-icon bg-green"><i class="fa-solid fa-house"></i></span>
        <div class="info-box-content"> <span class="info-box-text">{{__('Total Shed') }}</span> <span class="info-box-number">{{$total_sheds}}</span> </div>
      </div>
