      ...
      <div class="col-md-7">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div class="form-group row">
              <label class="col-md-4 col-form-label" for="email">{{__('human_resource_form.email_address') }} : 
              <!--<span class="validate">*</span>-->
              </label>
              <div class="col-md-8">
                <input type="email" name="email" class="form-control" value="{{  (isset($editData->email))?$editData->email:old('email')  }}" placeholder="somthing@example.com" id="email" >
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <textarea class="form-control" name="parmanent_address" id="parmanent_address" >{{(isset($editData->parmanent_address))?$editData->parmanent_address:old('parmanent_address')}}</textarea>
              </div>
            </div>
            <div class="form-group row">
