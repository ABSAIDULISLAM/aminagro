...
<form action="{{ route('AddPondSave') }}" method="POST">
    @csrf
  <div class="form-row">
    <div class="form-group col-md-12">
    <label for="inputEmail4">পুকুরের নাম*</label>
    <input type="text" class="form-control" id="inputEmail4" placeholder="পুকুরের নাম" name="pond_name">
    </div>
    <div class="form-group col-md-12">
    <label for="inputEmail4">পুকুরের লোকেশন*</label>
    <input type="text" class="form-control" id="inputEmail4" placeholder="পুকুরের লোকেশন" name="address">
    </div>
  </div>
