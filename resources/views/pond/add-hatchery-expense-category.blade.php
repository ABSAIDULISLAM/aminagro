...
@section('title', __('খরচ ক্যাটেগরী যুক্ত কর'))
@section('content') 
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
<section class="content-header">
  <h1><i class="icon-list"></i> {{__('খরচ ক্যাটেগরী যুক্ত কর') }}</h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> {{__('same.home') }}</a></li>
    <li class="active">{{__('খরচ ক্যাটেগরী যুক্ত কর') }}</li>
  </ol>
</section>
...
<form action="{{ route('add_hatchery_expense_category_save') }}" method="POST">
    @csrf
  <div class="form-row">
