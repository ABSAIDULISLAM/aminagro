...
<section class="content-header">
  <h1><i class="icon-list"></i> {{__('Dead Calf') }}</h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> {{__('same.home') }}</a></li>
    <li class="active">{{__('Dead Calf') }}</li>
  </ol>
</section>
...
<form action="{{ route('save-dead-calf') }}" method="POST">
    @csrf
...
<div class="form-group col-md-12">
    <label for="exampleFormControlSelect1">বাছুর*</label>
    <select class="form-control select2" id="exampleFormControlSelect1" name="calf">
