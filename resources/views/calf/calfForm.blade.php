		    			...
		    			<div class="col-md-12"> 
							...
							<div class="col-md-4">
                              <div class="form-group">
                                ...
                                <input id="animal-id" type="text" name="id" placeholder="Animal ID" class="form-control">
                              </div>
                            </div>
							<div class="col-md-4">
                              <div class="form-group">
                                <label for="father_id">{{__('Father ID') }} : </label>
                                <input id="father_id" type="text" name="father_id" placeholder="Father ID" class="form-control">
                              </div>
                            </div>
							<div class="col-md-4">
                              <div class="form-group">
                                <label for="father_id">{{__('Father Name') }} : </label>
                                <input id="father_name" type="text" name="father_name" placeholder="Father Name" class="form-control">
                              </div>
                            </div>
							<div class="col-md-4">
                              <div class="form-group">
                                <label for="company_name">{{__('Company Name') }} : </label>
                                <input id="company_name" type="text" name="company_name" placeholder="Company Name" class="form-control">
                              </div>
                            </div>
							<div class="col-md-4">
                              <div class="form-group">
                                <label for="father_id">{{__('Calf Blood') }} : </label>
                                <input id="claf_blood" type="text" name="claf_blood" placeholder="Calf Blood" class="form-control">
                              </div>
                            </div>
            							
							<div class="col-md-4"> 
								<div class="form-group">
							    	<label for="animal_id">{{__('manage_cow.mother_id') }} : </label>
							...
							<div class="col-md-4"> 
								<div class="form-group">
							    	<label for="height">{{__('manage_cow.height') }} : </label>
							    	<input type="text" name="height" class="form-control" value="{{(!empty($single_data->height))?$single_data->height:''}}" >
							   	</div>
							</div>
							<div class="col-md-4"> 
								<div class="form-group">
