...
<form action="{{ route('save_spoiled_milk') }}" method="POST">
    @csrf
    <div class="form-group col-md-12">
        <label for="inputEmail4">Quantity*</label>
        <input type="text" class="form-control" id="inputEmail4" placeholder="Quantity" name="qty">
    </div>
    
    <div class="form-group col-md-12">
        <label for="exampleFormControlSelect1">Account No*</label>
        <select class="form-control select2" id="exampleFormControlSelect1" name="account">
            @foreach($CollectMilk as $CollectMilks)
                <option value="{{ $CollectMilks->account_number }}">{{ $CollectMilks->account_number }}</option>
            @endforeach
        </select>
    </div>
    <script>
    ...
    <div class="form-group col-md-12">
        ...
        <input type="date" class="form-control" id="inputPassword4" placeholder="date" name="date" style="width: 25%;">
    </div>
    <div class="form-group col-md-12">
