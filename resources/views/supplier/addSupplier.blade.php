  ...
  <div class="box box-success">
    ...
    <div class="box-body">
      <div class="col-md-8">
        ...
        <div class="col-md-12">
          <div class="form-group">
            <label for="mail_address">{{__('supplier.email') }} : </label>
            <input type="email" class="form-control" id="mail_address" value="{{  (isset($singleData->mail_address))?$singleData->mail_address:old('mail_address')  }}" name="mail_address" placeholder="{{__('supplier.email') }}">
          </div>
        </div>
        <div class="col-md-12">
          <div class="form-group">
