          ...
          <div class="panel-body">
            ...
            <table class="table table-bordered table-striped table-responsive table-hover">
              ...
              <tr>
                ...
                <td>{{ optional($data->branch)->branch_name ?? 'N/A' }}</td>

                <td>{{  $data->shed_number  }}</td>
                <td>{{  $data->Capacity  }}</td>
                <?php

                $totalCow = DB::table('animals')
                    ->where('shade_no', $data->id)->where('sale_status', 0)
                    ->count();
                $totalCalf = DB::table('calf')
                    ->where('shade_no', $data->id)->where('sale_status', 0)
                    ->count();
                ?>
                <td>{{  $totalCow +  $totalCalf }}</td>
                <td>@if($data->status == 1)
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="form-group">
                            ...
                            <div class="col-md-12"> {{Form::label('Capacity')}} <span class="validate">*</span> :
                              <input type="text" class="form-control" value="{{  $data->Capacity  }}" name="Capacity" placeholder="Capacity" required>
                            </div>
  ...
  <div class="modal fade" id="saveModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="form-group">
            <div class="col-md-12"> {{Form::label('shed_number', __('Capacity'))}} <span class="validate">*</span> :
              <input type="text" class="form-control" id="Capacity" value="" name="Capacity" placeholder="Capacity" required>
            </div>
          </div>
<!--<div id="animal-container">-->
<!--    <div class="form-row animal-row">-->
<!--        <div class="form-group col-md-4">-->
<!--            <label for="inputEmail4">Category*</label>-->
<!--            <select class="form-control" name="supplier[]">-->
<!--                @foreach ($Animal as $Animals)-->
<!--                    <option value="{{ $Animals->id }}">{{ $Animals->type_name }}</option>-->
<!--                @endforeach-->
<!--            </select>-->
<!--        </div>-->
<!--        <div class="form-group col-md-4" style="margin-left: 10px;">-->
<!--            <label for="inputEmail4">Quantity*</label>-->
<!--            <input type="text" class="form-control" name="shed_number[]" placeholder="Quantity" required>-->
<!--        </div>-->
<!--        <div class="form-group col-md-4" style="margin-top: 26px; margin-left: 10px;">-->
<!--            <button type="button" class="btn btn-primary" id="add-animal">Add New</button>-->
<!--        </div>-->
<!--    </div>-->
<!--</div>-->
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        addButton.addEventListener("click", function () {
            ...
            newField.classList.add("form-row", "animal-row");
            newField.innerHTML = `
                <div class="form-group col-md-4">
                    <label for="inputEmail4">Category*</label>
                    <select class="form-control" name="supplier[]">
                ...
                <div class="form-group col-md-4" style="margin-top: 26px; margin-left: 10px;">
                    <button type="button" class="btn btn-danger remove-animal">X</button>
                </div>
            `;
        ...
        container.addEventListener("click", function (e) {
            if (e.target.classList.contains("remove-animal")) {
                e.target.closest(".animal-row").remove();
            }
        });
    });
</script>
