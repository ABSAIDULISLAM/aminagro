...
<form action="{{ route('sellbeefsave') }}" method="POST">
    @csrf
    ...
    <div class="form-group col-md-12">
        ...
        <input type="date" class="form-control" id="inputPassword4" placeholder="তারিখ" name="date" style="width: 25%;">
    </div>
    <div class="form-group col-md-12">
        <label for="inputEmail4">গোশতের পরিমাণ*</label>
        <input type="text" class="form-control" id="inputEmail4" placeholder="গোশতের পরিমাণ" name="qty">
    </div>
    <div class="form-group col-md-12">
    <label for="price">মূল্য*</label>
    <input type="text" class="form-control" id="price" placeholder="মূল্য" name="price">
    </div>
    
    <div class="form-group col-md-12">
    <label for="total_price">পেমেন্ট*</label>
    <input type="text" class="form-control" id="total_price" placeholder="পেমেন্ট" name="total_price">
    </div>
    
    <div class="form-group col-md-12">
    <label for="due_price">বাকি*</label>
    <input type="text" class="form-control" id="due_price" placeholder="বাকি" name="due_price" readonly>
    </div>
