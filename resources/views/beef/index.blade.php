...
<form action="{{ route('beefsave') }}" method="POST">
    @csrf
...
<script>
    ...
    <div class="form-group col-md-12">
      <label for="inputPassword4">গোস্তের পরিমান*</label>
      <input type="text" class="form-control" id="inputPassword4" placeholder="মোট গোশত*"name="qty">
    </div>
    
<div class="form-group col-md-12">
    <label for="exampleFormControlSelect1">ইউনিট*</label>
    <select class="form-control select2" id="exampleFormControlSelect1" name="unit">
